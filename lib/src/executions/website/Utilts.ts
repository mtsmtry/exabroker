...
export function getFormHiddenInputDataFromElement(elm: Element): object {
    // Hidden inputs
    const inputs = elm.find(".//input[@type='hidden']");
...
export function getFormHiddenInputData(doc: Document, xpath: string): object {
    ...
    return getFormHiddenInputDataFromElement(form);
}
